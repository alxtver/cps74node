class PKI {
  constructor(ean_code, type_pki, vendor, model, country, part, serial_number, number_machine) {
...
class APKZI {
  constructor(apkzi_name, kont_name, fdsi, fdsiKontr, zav_number, kontr_zav_number, part, number_machine) {
